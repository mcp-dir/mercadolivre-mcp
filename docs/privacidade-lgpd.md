...
Mercado Livre Vendedor segue a LGPD (Lei nº 13.709/2018).
...
|---|---|---|
| **Mercado Livre** | BR | marketplace API provider (provedor dos dados do usuário) |
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [mercadolivre@mcp.ai](mailto:mercadolivre@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
